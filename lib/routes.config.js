...
function create_route_service_db(
  ...
  EXPRESS_APP.addPostRoute(
    ...
    EXPRESS_APP.asyncHandler()(async (req, res, next) => {
      ...
      // If not not nul pre handle action
      if (functionBeforeAction != null && functionBeforeAction != undefined) {
        bodydRequest = functionBeforeAction("/list", req);
      }
      ...
      if (functionAfterAction != null && functionAfterAction != undefined) {
        responseData = functionAfterAction("/list", req, responseData);
      }
  ...
  EXPRESS_APP.addPostRoute(
    ...
    EXPRESS_APP.asyncHandler()(async (req, res, next) => {
      ...
      // If not not nul pre handle action
      if (functionBeforeAction != null && functionBeforeAction != undefined) {
        bodydRequest = functionBeforeAction("/listOnlyFields", req);
      }
      const data = await EXPRESS_APP.mapProperties.SERVICES[
        serviceName
      ].findAllOnlyFields(
  ...
  EXPRESS_APP.addPostRoute(
    ...
    EXPRESS_APP.asyncHandler()(async (req, res, next) => {
      ...
      // If not not nul pre handle action
      if (functionBeforeAction != null && functionBeforeAction != undefined) {
        bodydRequest = functionBeforeAction("/read", req);
      }
      ...
      if (functionAfterAction != null && functionAfterAction != undefined) {
        responseData = functionAfterAction("/read", req, responseData);
      }
  ...
  EXPRESS_APP.addPostRoute(
    ...
    EXPRESS_APP.asyncHandler()(async (req, res, next) => {
      ...
      // If not not nul pre handle action
      if (functionBeforeAction != null && functionBeforeAction != undefined) {
        bodydRequest = functionBeforeAction("/delete", req);
      }
      const data = await EXPRESS_APP.mapProperties.SERVICES[
        serviceName
      ...
      if (functionAfterAction != null && functionAfterAction != undefined) {
        responseData = functionAfterAction("/delete", req, responseData);
      }
  ...
  EXPRESS_APP.addPostRoute(
    ...
    EXPRESS_APP.asyncHandler()(async (req, res, next) => {
      ...
      // If not not nul pre handle action
      if (functionBeforeAction != null && functionBeforeAction != undefined) {
        bodydRequest = functionBeforeAction("/edit", req);
      }
      ...
      if (functionAfterAction != null && functionAfterAction != undefined) {
        responseData = functionAfterAction("/edit", req, responseData);
      }
  ...
  EXPRESS_APP.addPostRoute(
    ...
    EXPRESS_APP.asyncHandler()(async (req, res, next) => {
      ...
      // If not not nul pre handle action
      if (functionBeforeAction != null && functionBeforeAction != undefined) {
        bodydRequest = functionBeforeAction("/add", req);
      }
      let data = await EXPRESS_APP.mapProperties.SERVICES[serviceName].save(
        bodydRequest.data
      );
      ...
      if (functionAfterAction != null && functionAfterAction != undefined) {
        responseData = functionAfterAction("/add", req, responseData);
      }
  ...
  EXPRESS_APP.addPostRoute(
    ...
    EXPRESS_APP.asyncHandler()(async (req, res, next) => {
      ...
      // If not not nul pre handle action
      if (functionBeforeAction != null && functionBeforeAction != undefined) {
        bodydRequest = functionBeforeAction("/loadNew", req);
      }
      ...
      if (functionAfterAction != null && functionAfterAction != undefined) {
        responseData = functionAfterAction("/loadNew", req, responseData);
      }
