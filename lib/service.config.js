...
class BaseCrudService extends BaseService {
  ...
  async count(filters, fetchs, transaction) {
    return await this.dao.count(filters, fetchs, transaction);
  }
  ...
  async findAll(filters, fetchs, orders, limit, transaction) {
    return await this.dao.findAll(filters, fetchs, orders, limit, transaction);
  }
  ...
  async findOne(filters, fetchs, orders, limit, transaction) {
    return await this.dao.findOne(filters, fetchs, orders, limit, transaction);
  }
